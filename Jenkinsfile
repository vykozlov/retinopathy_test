      ...
      stage ('Clone repositories') {
          dir("${appName}") {
              checkout([$class: 'GitSCM', branches: [[name: '*/master']],
                  ...
                  userRemoteConfigs: [[url: "http://github.com/itokeiic/${appName}.git"]]])
          }

          dir("DEEP-OC-${appName}") {
              checkout([$class: 'GitSCM', branches: [[name: '*/master']],
                  credentialsId: "${githubcredentials}",
                  userRemoteConfigs: [[url: "http://github.com/itokeiic/DEEP-OC-${appName}.git"]]])
          }
      }
